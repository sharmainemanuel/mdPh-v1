...
$(document).ready(function()
{
    ...
    if (!navigator.geolocation) 
    {
      ...
      vLat =14.837888; vLong =120.283600;
      
      
      $.ajax({
        type: "GET",
       url: "http://gcccs.org/mdph/drugstore.php",
       async: false,
        success: function(myData){
          for(var i = 0; i< myData.length; i++){
          arrFacility.push(myData[i].flddsname);
          arrLat.push(myData[i].fldlat);
          arrLon.push(myData[i].fldlon);}
        }
      });
